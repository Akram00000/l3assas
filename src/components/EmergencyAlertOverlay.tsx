...
async function playSonorAlarm(alert: AlertLevel, language: 'ar' | 'fr') {
...
export function EmergencyAlertOverlay({
  ...
  useEffect(() => {
    ...
    if (changed && soundEnabled && (alert === 'FIRE' || alert === 'WARNING')) {
      void playSonorAlarm(alert, language);
    }
      ...
      {alert === 'WARNING' && (
        <View style={styles.warningOverlayRoot}>
          ...
          <View style={styles.warningCard}>
            ...
            <Text style={styles.warningBadgeValue}>{t.potentialFireAlert}</Text>
